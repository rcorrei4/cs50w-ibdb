# Generated by Django 3.1.1 on 2021-05-24 01:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateField(default=datetime.date(2000, 2, 2))),
                ('original_title', models.CharField(default='', max_length=128)),
                ...
                ('protection', models.BooleanField(default=False, max_length=128)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='user',
            name='read',
            field=models.ManyToManyField(related_name='books_already_read', to='books.Book'),
        ),
        migrations.AddField(
            model_name='user',
            name='reading',
            field=models.ManyToManyField(related_name='books_currently_reading', to='books.Book'),
        ),
        migrations.AddField(
            model_name='user',
        ...
        migrations.AddField(
            model_name='user',
            name='want_to_read',
            field=models.ManyToManyField(related_name='books_to_read', to='books.Book'),
        ),
    ]
